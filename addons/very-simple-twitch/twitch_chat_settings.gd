...
const settings: Dictionary = {
	"client_id":
	{
		...
		"type": TYPE_STRING,
		"help": "The client id from the twitch developer dashboard",
		"is_basic": true,
		"initial_value": "",
	},
	"redirect_host":
	{
		...
		"type": TYPE_STRING,
		"help": "The host where the OAuth Callback will be received",
		"is_basic": false,
	...
	"uuid":
	{
		...
		"type": TYPE_STRING,
		"help": "The useless UID to hide the token from the web browser",
		"is_basic": false,
		"initial_value":
	...
	"redirect_port":
	{
		...
		"type": TYPE_INT,
		"help": "The port where the oauth callback will be redirect",
		"is_basic": true,
		"initial_value": 8090,
	},
	"disk_cache_path":
	{
		...
		"help": "The absolute filepath where the images cache will be stored",
		"is_basic": false,
	...
	"disk_cache":
	{
		...
		"type": TYPE_BOOL,
		"help": "Use cache to store the images from badges and emotes",
		"is_basic": true,
		"initial_value": true,
	},
	"scopes":
	...
	"twitch_port":
	{
		...
		"type": TYPE_INT,
		"help": "The port the websocket will connect to",
		"is_basic": false,
		"initial_value": 443,
	},
	"twitch_anon_user":
	...
	"twitch_timeout_ms":
	{
		...
		"type:": TYPE_INT,
		"help": "Time between messages sent by the client",
		"is_basic": false,
		"initial_value": 320,
	}
}
...
static func add_settings():
	for setting in settings:
		...
		var property_info = {
			...
			"hint": setting_value.get("hint", PROPERTY_HINT_NONE),
